...
% Inserts PDF image
\begin{figure}[h]
  \includegraphics{/Users/yves/Projects/lbnl/LBL-Linkage-Widget-v2/server/src/sequence/svg-inkscape/control-logic_svg-tex.pdf}
%  \includesvg{control-logic}
\end{figure}

% Inserts PNG
\begin{figure}[h]
  \includegraphics{/Users/yves/Projects/lbnl/LBL-Linkage-Widget-v2/server/src/sequence/latex-assets/image6.png}
\end{figure}
