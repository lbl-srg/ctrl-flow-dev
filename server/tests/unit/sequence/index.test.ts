...
const EXAMPLE_SELECTIONS = {"Buildings.Templates.ZoneEquipment.Components.Controls.Interfaces.PartialVAVBoxController.have_CO2Sen": false, "Buildings.Controls.OBC.ASHRAE.G36.AHUs.MultiZone.VAV.Controller.buiPreCon": "ReturnFanCalculatedAir", "Buildings.Templates.ZoneEquipment.Types.Configuration": "CO", "DEL_ENERGY_ASHRAE": true, "DEL_ENERGY_TITLE24": false, "DEL_VENTILATION_ASHRAE": true, "DEL_VENTILATION_TITL24": false, "UNITS": "SI", "DEL_INFO_BOX": false};
