  ...
  return (
    <Modal close={close} isOpen={isOpen}>
      ...
      <div className="info-container">
        ...
        <p>The software developed for this tool is protected by copyright and is available for use under open source terms. For details please contact us by email: {email}</p>
