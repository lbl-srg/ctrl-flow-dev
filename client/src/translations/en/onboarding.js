export default [
...

  {
    ...
    points: [
      ...
      "Note that the initial release of this tool has limited system support. Additional systems will be added in future releases."
    ],
  },
...

  {
    ...
    points: [
      "For each type of equipment click on the “Edit” button to configure.",
      "On the right side of the page you can select equipment configuration and control options.",
      "Click “Save” when done and then repeat for the other equipment on the project.",
    ],
  },
...

  {
    ...
    copy: "Once systems are selected and configured you will be able to download a customized sequence of operations document for your project. Note that careful review and further editing of this document may be required.",
    points: [],
  },
